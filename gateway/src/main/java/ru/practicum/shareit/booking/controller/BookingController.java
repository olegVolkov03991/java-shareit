...
public class BookingController {
    ...
    public ResponseEntity<Object> getBookingCurrentOwner(@RequestHeader("X-Sharer-User-Id") long userId,
        ...
        BookingState state = BookingState.from(stateParam)
                .orElseThrow(() -> new ValidationException(String.format("Unknown state: %s", stateParam)));
        log.info("Get booking owner with state {}, user{}, from{}, size{}", stateParam, userId, from, size);
    ...
    public ResponseEntity<Object> bookItem(@RequestHeader("X-Sharer-User-Id") long userId,
        ...
        log.info("Creating booking request{}, user{}", requestDto, userId);
    ...
    public ResponseEntity<Object> approveStatus(@RequestHeader("X-Sharer-User-Id") long userId,
        ...
        log.info("update status{}, bookingId{}, userId{}", approved, bookingId, userId);
