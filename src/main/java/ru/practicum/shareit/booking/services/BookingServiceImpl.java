...
public class BookingServiceImpl implements BookingService {
    ...
    public BookingFullDto createBooking(BookingDto bookingDto, Integer bookerId) {
        ...
        Booking booking = bookingRepository.save(BookingMapper.toBooking(bookingDto, bookerId, Status.WAITING));
    ...
    @Override
    public Collection<BookingFullDto> findUserBookings(Integer bookerId, String state) {
        User booker = validateUser(bookerId);
    ...
    @Override
    public Collection<BookingFullDto> findOwnerBookings(Integer ownerId, String state) {
        validateUser(ownerId);
        try {
        ...
        return bookingRepository.findAllByOwnerId(ownerId, state, LocalDateTime.now())
                .stream()
